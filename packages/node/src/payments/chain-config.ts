...
const CHAIN_CONFIGS: Record<ChainId, ChainConfig> = {
  ...
  'base-local': {
    ...
    // Nonce sequence: 0=USDC, 1=Registry, 2=ANTSToken, 3=AntseedRegistry,
    // 4=Staking, 5=Deposits, 6=Channels, 7=StatsV2, 8=Emissions, 9=SubPool.
    ...
    usageReportStatsContractAddress: '0xa513E6E4b8f2a923D98304ec87F64353C4D5C853',
